...
const Menu = ({handleSelect, startGame}) => {
    ...
    return (
        <div className="w-full max-w-xs h-full bg-black-500 flex flex-col px-4 py-8">
            <label for="tiles" className="text-gray-300 italic ml-4 text-xl">Playing with ...</label>
            ...
            <label for="tiles" className="text-gray-300 italic mx-4 text-xl">Category A:</label>
            ...
            <label for="tiles" className="text-gray-300 italic mx-4 text-xl">Category B:</label>
